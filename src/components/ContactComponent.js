...
class Contact extends Component{
    ...
    handleSubmit(values){
        ...
        alert(" Your Feedback is Saved into the server ");
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
		              ...
		              Rajasthan, India<br />
                            ...
                            <i className="fa fa-envelope"></i>: <a href="mailto:confusion@food.net">riteshm2099@gmail.com</a>
                        </address>
                    </div>
                    <div className="col-12 col-sm-6 offset-sm-1">
                        <h5>Map of our Location</h5>
                        <img src="location.jpg" alt="Location_Image"/>
                    </div>
